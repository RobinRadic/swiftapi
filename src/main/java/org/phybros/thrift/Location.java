...
public class Location implements org.apache.thrift.TBase<Location, Location._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(Location other) {
    ...
    lastComparison = Boolean.valueOf(isSetYaw()).compareTo(typedOther.isSetYaw());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetYaw()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.yaw, typedOther.yaw);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
