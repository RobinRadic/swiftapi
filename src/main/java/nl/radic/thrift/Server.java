...
public class Server implements org.apache.thrift.TBase<Server, Server._Fields>, java.io.Serializable, Cloneable, Comparable<Server> {
  ...
  public Server(Server other) {
    ...
    if (other.isSetOfflinePlayers()) {
      List<OfflinePlayer> __this__offlinePlayers = new ArrayList<OfflinePlayer>(other.offlinePlayers.size());
    ...
    if (other.isSetOnlinePlayers()) {
      List<Player> __this__onlinePlayers = new ArrayList<Player>(other.onlinePlayers.size());
    ...
    if (other.isSetWhitelist()) {
      List<OfflinePlayer> __this__whitelist = new ArrayList<OfflinePlayer>(other.whitelist.size());
    ...
    if (other.isSetBannedPlayers()) {
      List<OfflinePlayer> __this__bannedPlayers = new ArrayList<OfflinePlayer>(other.bannedPlayers.size());
    ...
    if (other.isSetBannedIps()) {
      List<String> __this__bannedIps = new ArrayList<String>(other.bannedIps);
      this.bannedIps = __this__bannedIps;
    }
    if (other.isSetWorlds()) {
      List<World> __this__worlds = new ArrayList<World>(other.worlds.size());
  ...
  public int hashCode() {
    ...
    boolean present_offlinePlayers = true && (isSetOfflinePlayers());
    list.add(present_offlinePlayers);
    if (present_offlinePlayers)
      list.add(offlinePlayers);

    boolean present_onlinePlayers = true && (isSetOnlinePlayers());
    list.add(present_onlinePlayers);
    if (present_onlinePlayers)
      list.add(onlinePlayers);
    ...
    boolean present_bukkitVersion = true && (isSetBukkitVersion());
    list.add(present_bukkitVersion);
    if (present_bukkitVersion)
      list.add(bukkitVersion);
    ...
    boolean present_allowFlight = true;
    list.add(present_allowFlight);
    if (present_allowFlight)
      list.add(allowFlight);

    boolean present_allowNether = true;
    list.add(present_allowNether);
    if (present_allowNether)
      list.add(allowNether);

    boolean present_allowEnd = true;
    list.add(present_allowEnd);
    if (present_allowEnd)
      list.add(allowEnd);

    boolean present_whitelist = true && (isSetWhitelist());
    list.add(present_whitelist);
    if (present_whitelist)
      list.add(whitelist);

    boolean present_bannedPlayers = true && (isSetBannedPlayers());
    list.add(present_bannedPlayers);
    if (present_bannedPlayers)
      list.add(bannedPlayers);

    boolean present_bannedIps = true && (isSetBannedIps());
    list.add(present_bannedIps);
    if (present_bannedIps)
      list.add(bannedIps);

    boolean present_worlds = true && (isSetWorlds());
    list.add(present_worlds);
    if (present_worlds)
      list.add(worlds);

    boolean present_health = true && (isSetHealth());
  ...
  public int compareTo(Server other) {
    ...
    lastComparison = Boolean.valueOf(isSetOfflinePlayers()).compareTo(other.isSetOfflinePlayers());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOfflinePlayers()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.offlinePlayers, other.offlinePlayers);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetOnlinePlayers()).compareTo(other.isSetOnlinePlayers());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetBukkitVersion()).compareTo(other.isSetBukkitVersion());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBukkitVersion()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.bukkitVersion, other.bukkitVersion);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetAllowFlight()).compareTo(other.isSetAllowFlight());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAllowFlight()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.allowFlight, other.allowFlight);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetAllowNether()).compareTo(other.isSetAllowNether());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAllowNether()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.allowNether, other.allowNether);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetAllowEnd()).compareTo(other.isSetAllowEnd());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAllowEnd()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.allowEnd, other.allowEnd);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetWhitelist()).compareTo(other.isSetWhitelist());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWhitelist()) {
    ...
    lastComparison = Boolean.valueOf(isSetBannedPlayers()).compareTo(other.isSetBannedPlayers());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBannedPlayers()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.bannedPlayers, other.bannedPlayers);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetBannedIps()).compareTo(other.isSetBannedIps());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBannedIps()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.bannedIps, other.bannedIps);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetWorlds()).compareTo(other.isSetWorlds());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWorlds()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.worlds, other.worlds);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                OfflinePlayer _elem35;
                for (int _i36 = 0; _i36 < _list34.size; ++_i36)
                {
                  _elem35 = new OfflinePlayer();
                  _elem35.read(iprot);
                  struct.offlinePlayers.add(_elem35);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                for (int _i39 = 0; _i39 < _list37.size; ++_i39)
                {
                  _elem38 = new Player();
                  _elem38.read(iprot);
                  struct.onlinePlayers.add(_elem38);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                OfflinePlayer _elem41;
                for (int _i42 = 0; _i42 < _list40.size; ++_i42)
                {
                  _elem41 = new OfflinePlayer();
                  _elem41.read(iprot);
                  struct.whitelist.add(_elem41);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                OfflinePlayer _elem44;
                for (int _i45 = 0; _i45 < _list43.size; ++_i45)
                {
                  _elem44 = new OfflinePlayer();
                  _elem44.read(iprot);
                  struct.bannedPlayers.add(_elem44);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                ServerHealth _elem53;
                for (int _i54 = 0; _i54 < _list52.size; ++_i54)
                {
                  _elem53 = new ServerHealth();
                  _elem53.read(iprot);
                  struct.health.add(_elem53);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(1)) {
        {
          ...
          OfflinePlayer _elem70;
          for (int _i71 = 0; _i71 < _list69.size; ++_i71)
          {
            _elem70 = new OfflinePlayer();
            _elem70.read(iprot);
            struct.offlinePlayers.add(_elem70);
          }
        }
        struct.setOfflinePlayersIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          for (int _i74 = 0; _i74 < _list72.size; ++_i74)
          {
            _elem73 = new Player();
            _elem73.read(iprot);
            struct.onlinePlayers.add(_elem73);
          }
        }
        struct.setOnlinePlayersIsSet(true);
      }
      ...
      if (incoming.get(11)) {
        {
          ...
          OfflinePlayer _elem76;
          for (int _i77 = 0; _i77 < _list75.size; ++_i77)
          {
            _elem76 = new OfflinePlayer();
            _elem76.read(iprot);
            struct.whitelist.add(_elem76);
          }
        }
        struct.setWhitelistIsSet(true);
      }
      if (incoming.get(12)) {
        {
          ...
          OfflinePlayer _elem79;
          for (int _i80 = 0; _i80 < _list78.size; ++_i80)
          {
            _elem79 = new OfflinePlayer();
            _elem79.read(iprot);
            struct.bannedPlayers.add(_elem79);
          }
        }
        struct.setBannedPlayersIsSet(true);
      }
      ...
      if (incoming.get(15)) {
        {
          ...
          ServerHealth _elem88;
          for (int _i89 = 0; _i89 < _list87.size; ++_i89)
          {
            _elem88 = new ServerHealth();
            _elem88.read(iprot);
            struct.health.add(_elem88);
          }
        }
        struct.setHealthIsSet(true);
      }
