...
public class PlayerInventory implements org.apache.thrift.TBase<PlayerInventory, PlayerInventory._Fields>, java.io.Serializable, Cloneable, Comparable<PlayerInventory> {
  ...
  private List<ItemStack> inventory; // required
  private ItemStack itemInHand; // required
  private PlayerArmor armor; // required
  ...
  public PlayerInventory(PlayerInventory other) {
    if (other.isSetInventory()) {
      List<ItemStack> __this__inventory = new ArrayList<ItemStack>(other.inventory.size());
  ...
  public int hashCode() {
    ...
    boolean present_itemInHand = true && (isSetItemInHand());
    list.add(present_itemInHand);
    if (present_itemInHand)
      list.add(itemInHand);

    boolean present_armor = true && (isSetArmor());
    list.add(present_armor);
    if (present_armor)
      list.add(armor);
  ...
  public int compareTo(PlayerInventory other) {
    ...
    lastComparison = Boolean.valueOf(isSetItemInHand()).compareTo(other.isSetItemInHand());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetItemInHand()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.itemInHand, other.itemInHand);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  _elem19 = new ItemStack();
                  _elem19.read(iprot);
                  struct.inventory.add(_elem19);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          {
            _elem24 = new ItemStack();
            _elem24.read(iprot);
            struct.inventory.add(_elem24);
          }
        }
        struct.setInventoryIsSet(true);
      }
