...
public class ItemStack implements org.apache.thrift.TBase<ItemStack, ItemStack._Fields>, java.io.Serializable, Cloneable, Comparable<ItemStack> {
  ...
  private int durability; // required
  private Map<Enchantment,Integer> enchantments; // required
  private List<String> lore; // required
  ...
  public ItemStack(ItemStack other) {
    ...
    if (other.isSetEnchantments()) {
      Map<Enchantment,Integer> __this__enchantments = new HashMap<Enchantment,Integer>(other.enchantments.size());
    ...
    if (other.isSetLore()) {
      List<String> __this__lore = new ArrayList<String>(other.lore);
  ...
  public int hashCode() {
    ...
    boolean present_durability = true;
    list.add(present_durability);
    if (present_durability)
      list.add(durability);

    boolean present_enchantments = true && (isSetEnchantments());
    list.add(present_enchantments);
    if (present_enchantments)
      list.add(enchantments);

    boolean present_lore = true && (isSetLore());
    list.add(present_lore);
    if (present_lore)
      list.add(lore);
  ...
  public int compareTo(ItemStack other) {
    ...
    lastComparison = Boolean.valueOf(isSetEnchantments()).compareTo(other.isSetEnchantments());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEnchantments()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.enchantments, other.enchantments);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetLore()).compareTo(other.isSetLore());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLore()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.lore, other.lore);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                {
                  _key1 = nl.radic.swiftapi.thrift.Enchantment.findByValue(iprot.readI32());
                  _val2 = iprot.readI32();
                  struct.enchantments.put(_key1, _val2);
                }
                iprot.readMapEnd();
              }
      ...
      if (incoming.get(3)) {
        {
          ...
          {
            _key12 = nl.radic.swiftapi.thrift.Enchantment.findByValue(iprot.readI32());
            _val13 = iprot.readI32();
            struct.enchantments.put(_key12, _val13);
          }
        }
        struct.setEnchantmentsIsSet(true);
      }
