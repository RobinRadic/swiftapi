...
public class PlayerArmor implements org.apache.thrift.TBase<PlayerArmor, PlayerArmor._Fields>, java.io.Serializable, Cloneable, Comparable<PlayerArmor> {
  ...
  private ItemStack helmet; // required
  private ItemStack chestplate; // required
  private ItemStack leggings; // required
  private ItemStack boots; // required
  ...
  public int hashCode() {
    ...
    boolean present_helmet = true && (isSetHelmet());
    list.add(present_helmet);
    if (present_helmet)
      list.add(helmet);

    boolean present_chestplate = true && (isSetChestplate());
    list.add(present_chestplate);
    if (present_chestplate)
      list.add(chestplate);

    boolean present_leggings = true && (isSetLeggings());
    list.add(present_leggings);
    if (present_leggings)
      list.add(leggings);

    boolean present_boots = true && (isSetBoots());
    list.add(present_boots);
    if (present_boots)
      list.add(boots);
  ...
  public int compareTo(PlayerArmor other) {
    ...
    lastComparison = Boolean.valueOf(isSetHelmet()).compareTo(other.isSetHelmet());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHelmet()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.helmet, other.helmet);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetChestplate()).compareTo(other.isSetChestplate());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetChestplate()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.chestplate, other.chestplate);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetLeggings()).compareTo(other.isSetLeggings());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLeggings()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.leggings, other.leggings);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetBoots()).compareTo(other.isSetBoots());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBoots()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.boots, other.boots);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
