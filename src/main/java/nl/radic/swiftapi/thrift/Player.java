...
public class Player implements org.apache.thrift.TBase<Player, Player._Fields>, java.io.Serializable, Cloneable, Comparable<Player> {
  ...
  private GameMode gamemode; // required
  private boolean isSleeping; // required
  private boolean isSneaking; // required
  private boolean isSprinting; // required
  private boolean isInVehicle; // required
  private long xpToNextLevel; // required
  private int level; // required
  private String ip; // required
  private boolean isOp; // required
  private int foodLevel; // required
  private int health; // required
  private double exhaustion; // required
  private long firstPlayed; // required
  private long lastPlayed; // required
  private boolean isBanned; // required
  private boolean isWhitelisted; // required
  private PlayerInventory inventory; // required
  private double levelProgress; // required
  private int port; // required
  private Location location; // required
  private double healthDouble; // required
   ...
   * Whether the player is currently in a vehicle (minecart, boat, pig etc.)
   */
  public void setIsInVehicle(boolean isInVehicle) {
    this.isInVehicle = isInVehicle;
    setIsInVehicleIsSet(true);
  }
   ...
   * The health of the player. Use this instead of Player.health.
   */
  public void setHealthDouble(double healthDouble) {
    this.healthDouble = healthDouble;
    setHealthDoubleIsSet(true);
  }
        ...
        switch (schemeField.id) {
          ...
          case 2: // GAMEMODE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.gamemode = nl.radic.swiftapi.thrift.GameMode.findByValue(iprot.readI32());
